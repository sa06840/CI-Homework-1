...
#Parent Selection Schemes
    ...
    def fitnessProportional(self):
        ...
        randomIndex = random.uniform(0,1)  # print(randomIndex)
    ...
    for iteration in range(1, 11):
        ...
        for generation in range(T1.numOfGenerations):
            ...
            for i in range(5):
                ...
                # parents = T1.selectionTruncation()
                # parents = T1.fitnessProportional()
                # parents = T1.rankBased()
